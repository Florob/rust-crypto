...
impl<A: BlockEncryptor> GcmEncryptor<A> {
    pub fn new(algo: A) -> GcmEncryptor<A> {
...
impl<A: BlockEncryptor> AeadEncryptor for GcmEncryptor<A> {
    fn encrypt(&self, iv: &[u8], ad: &[u8], input: &[u8], output: &mut [u8]) {
        let in_len = input.len();
        let out_len = output.len();
        assert!(in_len <= out_len);
        let tag_len = out_len - in_len;
        ...
        slice::bytes::copy_memory(output[mut in_len..], tag[..tag_len]);
    }
}
...
mod test {
    ...
    static CASES: &'static [(&'static [u8], &'static [u8], &'static [u8],
                             &'static [u8], &'static [u8])] = &[
        // Format: (K, A, P, IV, C|T)
        ...
        (&[0xfe, 0xff, 0xe9, 0x92, 0x86, 0x65, 0x73, 0x1c,
         ...
         &[0x61, 0x35, 0x3b, 0x4c, 0x28, 0x06, 0x93, 0x4a, 0x77, 0x7f, 0xf5, 0x1f, 0xa2, 0x2a,
           ...
           0xc2, 0x3f, 0x45, 0x98, 0x36, 0x12, 0xd2, 0xe7, 0x9e, 0x3b, 0x07, 0x85, 0x56, 0x1b,
           0xe1, 0x4a, 0xac, 0xa2, 0xfc, 0xcb]),
        ...
        (&[0xfe, 0xff, 0xe9, 0x92, 0x86, 0x65, 0x73, 0x1c,
         ...
         &[0x8c, 0xe2, 0x49, 0x98, 0x62, 0x56, 0x15, 0xb6, 0x03, 0xa0, 0x33, 0xac, 0xa1, 0x3f,
           ...
           0x4c, 0x34, 0xae, 0xe5, 0x61, 0x9c, 0xc5, 0xae, 0xff, 0xfe, 0x0b, 0xfa, 0x46, 0x2a,
           0xf4, 0x3c, 0x16, 0x99, 0xd0, 0x50]),
        ...
        (&[0xfe, 0xff, 0xe9, 0x92, 0x86, 0x65, 0x73, 0x1c,
         ...
         &[0x39, 0x80, 0xca, 0x0b, 0x3c, 0x00, 0xe8, 0x41, 0xeb, 0x06,
           ...
           0x25, 0x19, 0x49, 0x8e, 0x80, 0xf1, 0x47, 0x8f, 0x37, 0xba,
        ...
        (&[0xfe, 0xff, 0xe9, 0x92, 0x86, 0x65, 0x73, 0x1c,
         ...
         &[0xd9, 0x31, 0x32, 0x25, 0xf8, 0x84, 0x06, 0xe5, 0xa5, 0x59,
           ...
           0xed, 0xf5, 0xaa, 0x0d, 0xe6, 0x57, 0xba, 0x63, 0x7b, 0x39],
         &[0xca, 0xfe, 0xba, 0xbe, 0xfa, 0xce, 0xdb, 0xad],
         &[0x0f, 0x10, 0xf5, 0x99, 0xae, 0x14, 0xa1, 0x54, 0xed, 0x24,
           0xb3, 0x6e, 0x25, 0x32, 0x4d, 0xb8, 0xc5, 0x66, 0x63, 0x2e,
           0xf2, 0xbb, 0xb3, 0x4f, 0x83, 0x47, 0x28, 0x0f, 0xc4, 0x50,
           0x70, 0x57, 0xfd, 0xdc, 0x29, 0xdf, 0x9a, 0x47, 0x1f, 0x75,
           0xc6, 0x65, 0x41, 0xd4, 0xd4, 0xda, 0xd1, 0xc9, 0xe9, 0x3a,
           0x19, 0xa5, 0x8e, 0x8b, 0x47, 0x3f, 0xa0, 0xf0, 0x62, 0xf7,
           0x65, 0xdc, 0xc5, 0x7f, 0xcf, 0x62, 0x3a, 0x24, 0x09, 0x4f,
           0xcc, 0xa4, 0x0d, 0x35, 0x33, 0xf8]),
        ...
        (&[0xfe, 0xff, 0xe9, 0x92, 0x86, 0x65, 0x73, 0x1c,
         ...
         &[0xd2, 0x7e, 0x88, 0x68, 0x1c, 0xe3, 0x24, 0x3c, 0x48, 0x30, 0x16, 0x5a, 0x8f, 0xdc,
           ...
           0xe9, 0xb7, 0x37, 0x3b, 0xdc, 0xf5, 0x66, 0xff, 0x29, 0x1c, 0x25, 0xbb, 0xb8, 0x56,
           0x8f, 0xc3, 0xd3, 0x76, 0xa6, 0xd9]),
        ...
        (&[0xfe, 0xff, 0xe9, 0x92, 0x86, 0x65, 0x73, 0x1c,
         ...
         &[0x52, 0x2d, 0xc1, 0xf0, 0x99, 0x56, 0x7d, 0x07, 0xf4, 0x7f, 0x37, 0xa3, 0x2a, 0x84,
           ...
           0xbc, 0xc9, 0xf6, 0x62, 0x89, 0x80, 0x15, 0xad, 0xb0, 0x94, 0xda, 0xc5, 0xd9, 0x34,
           0x71, 0xbd, 0xec, 0x1a, 0x50, 0x22, 0x70, 0xe3, 0xcc, 0x6c]),
        ...
        (&[0xfe, 0xff, 0xe9, 0x92, 0x86, 0x65, 0x73, 0x1c,
         ...
         &[0x52, 0x2d, 0xc1, 0xf0, 0x99, 0x56, 0x7d, 0x07, 0xf4, 0x7f, 0x37, 0xa3, 0x2a, 0x84,
           ...
           0x25, 0x55, 0xd1, 0xaa, 0x8c, 0xb0, 0x8e, 0x48, 0x59, 0x0d, 0xbb, 0x3d, 0xa7, 0xb0,
           0x8b, 0x10, 0x56, 0x82, 0x88, 0x38, 0xc5, 0xf6, 0x1e, 0x63, 0x93, 0xba, 0x7a, 0x0a,
           0xbc, 0xc9, 0xf6, 0x62, 0x76, 0xfc, 0x6e, 0xce, 0x0f, 0x4e, 0x17, 0x68, 0xcd, 0xdf,
           0x88, 0x53, 0xbb, 0x2d, 0x55, 0x1b]),
        ...
        (&[0xfe, 0xff, 0xe9, 0x92, 0x86, 0x65, 0x73, 0x1c,
         ...
         &[0xc3, 0x76, 0x2d, 0xf1, 0xca, 0x78, 0x7d, 0x32, 0xae, 0x47, 0xc1, 0x3b, 0xf1, 0x98,
           ...
           0xf4, 0x7c, 0x9b, 0x1f, 0x3a, 0x33, 0x7d, 0xbf, 0x46, 0xa7, 0x92, 0xc4, 0x5e, 0x45,
           0x49, 0x13, 0xfe, 0x2e, 0xa8, 0xf2]),
        ...
        (&[0xfe, 0xff, 0xe9, 0x92, 0x86, 0x65, 0x73, 0x1c,
         ...
         &[0x5a, 0x8d, 0xef, 0x2f, 0x0c, 0x9e, 0x53, 0xf1, 0xf7, 0x5d, 0x78, 0x53, 0x65, 0x9e,
           ...
           0x44, 0xae, 0x7e, 0x3f, 0xa4, 0x4a, 0x82, 0x66, 0xee, 0x1c, 0x8e, 0xb0, 0xc8, 0xb5,
           0xd4, 0xcf, 0x5a, 0xe9, 0xf1, 0x9a])
    ];

    #[test]
    fn encrypt() {
        for &(key, ad, p, iv, ct) in CASES.iter() {
            let mut out = Vec::from_elem(ct.len(), 0u8);

            match key.len() {
                16 => {
                    let enc = GcmEncryptor::new(aessafe::AesSafe128Encryptor::new(key));
                    enc.encrypt(iv, ad, p, out[mut]);
                },
                24 => {
                    let enc = GcmEncryptor::new(aessafe::AesSafe192Encryptor::new(key));
                    enc.encrypt(iv, ad, p, out[mut]);
                },
                32 => {
                    let enc = GcmEncryptor::new(aessafe::AesSafe256Encryptor::new(key));
                    enc.encrypt(iv, ad, p, out[mut]);
                },
                _ => unreachable!()
            }
